## ZAgent Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_zagent-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm zagent gateway --port 18789 --verbose
```
