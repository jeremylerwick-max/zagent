...
- Install via CLI: `zagent plugins install @zagent/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `zagent plugins install ./extensions/zalo`
   - From npm (if published): `zagent plugins install @zagent/zalo`
...
- Approve via:
  - `zagent pairing list zalo`
  - `zagent pairing approve zalo <CODE>`
...
- Example: `zagent message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `zagent channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `zagent logs --follow`
