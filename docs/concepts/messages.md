...
This page ties together how ZAgent handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. ZAgent keeps a
...
ZAgent separates the **prompt body** from the **command body**:
...
ZAgent can expose or hide model reasoning:
