...
ZAgent has two separate “streaming” layers:
...
When block streaming is enabled, ZAgent can **merge consecutive block chunks**
...
When draft streaming is active, ZAgent disables block streaming for that reply to avoid double-streaming.
