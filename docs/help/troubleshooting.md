...
You can also set `ZAGENT_VERBOSE=1` instead of the flag.
...
- Check the allowlist: `zagent config get agents.defaults.models`
...
If you can, include the relevant log tail from `zagent logs --follow`.
