...
You can point ZAgent at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ZAgent
...
- [Anthropic provider](/providers/anthropic) - Native ZAgent integration with Claude setup-token or API keys
