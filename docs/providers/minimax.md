---
summary: "Use MiniMax M2.1 in ZAgent"
read_when:
  - You want MiniMax models in ZAgent
...
Configure manually via `zagent.json`:
...
- Use `zagent models list` and `zagent models set minimax/MiniMax-M2.1` to switch.
...
- Running `zagent configure` and selecting **MiniMax M2.1**, or
