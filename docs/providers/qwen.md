---
summary: "Use Qwen OAuth (free tier) in ZAgent"
read_when:
  - You want to use Qwen with ZAgent
...
```bash
zagent models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, ZAgent will sync credentials
