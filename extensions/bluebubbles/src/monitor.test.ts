...
import { removeAckReactionAfterReply, shouldAckReaction } from "zagent/plugin-sdk";
import type { ZAgentConfig, PluginRuntime } from "zagent/plugin-sdk";
import {
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/zagent") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
