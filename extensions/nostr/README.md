...
Nostr DM channel plugin for ZAgent using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to ZAgent. It enables your bot to:
...
# Configure zagent to use local relay
