...
export function resolveTlonAccount(cfg: ZAgentConfig, accountId?: string | null): TlonResolvedAccount {
...
export function listTlonAccountIds(cfg: ZAgentConfig): string[] {
  const base = cfg.channels?.tlon as
