...
### Changes
- Version alignment with core ZAgent release numbers.
...
### Highlights
- First public release of the @zagent/voice-call plugin.
...
- CLI: `zagent voicecall` commands (call/start/continue/speak/end/status/tail/expose).
