...
function resolveAvatarSource(cfg: ZAgentConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ZAgentConfig, agentId: string): AgentAvatarResolution {
