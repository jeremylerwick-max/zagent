...
describe("createZAgentCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createZAgentCodingTools({
      config,
    ...
    const anthropicTools = createZAgentCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createZAgentCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createZAgentCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
