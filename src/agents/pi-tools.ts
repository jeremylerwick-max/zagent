...
function resolveExecConfig(cfg: ZAgentConfig | undefined) {
...
export function createZAgentCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createZAgentReadTool(freshReadTool)];
    }
