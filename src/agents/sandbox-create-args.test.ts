  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "zagent.sandbox=1",
        "--label",
        "zagent.sessionKey=main",
        "--label",
        "zagent.createdAtMs=1700000000000",
        "--label",
        "zagent.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
