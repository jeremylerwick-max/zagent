...
function resolveMainSessionKeyForSandbox(params: { cfg?: ZAgentConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: ZAgentConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`zagent sandbox explain --session ${runtime.sessionKey}`)}`,
  );
