...
function resolveMentionPatterns(cfg: ZAgentConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: ZAgentConfig | undefined, agentId?: string): RegExp[] {
