import type { BrowserConfig, BrowserProfileConfig, ZAgentConfig } from "../config/config.js";
import {
 ...
 *
 * Note: this is a ZAgent browser profile (routing config), not a Chrome user profile.
