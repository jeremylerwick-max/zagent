...
export function listChannelMessageActions(cfg: ZAgentConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: ZAgentConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: ZAgentConfig): boolean {
  for (const plugin of listChannelPlugins()) {
