...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "zagent-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<ZAgentConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<ZAgentConfig["telegram"]>>,
