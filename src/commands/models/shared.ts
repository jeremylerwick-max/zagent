...
export async function updateConfig(
  mutator: (cfg: ZAgentConfig) => ZAgentConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: ZAgentConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: ZAgentConfig): Set<string> {
