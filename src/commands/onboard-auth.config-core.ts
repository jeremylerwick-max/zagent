...
export function applyZaiConfig(cfg: ZAgentConfig): ZAgentConfig {
...
export function applyOpenrouterProviderConfig(cfg: ZAgentConfig): ZAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: ZAgentConfig): ZAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: ZAgentConfig): ZAgentConfig {
...
export function applyOpenrouterConfig(cfg: ZAgentConfig): ZAgentConfig {
...
export function applyMoonshotProviderConfig(cfg: ZAgentConfig): ZAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: ZAgentConfig): ZAgentConfig {
...
export function applyKimiCodeProviderConfig(cfg: ZAgentConfig): ZAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: ZAgentConfig): ZAgentConfig {
...
export function applySyntheticProviderConfig(cfg: ZAgentConfig): ZAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: ZAgentConfig): ZAgentConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: ZAgentConfig): ZAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: ZAgentConfig): ZAgentConfig {
