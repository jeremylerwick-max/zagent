export const LEGACY_PROJECT_NAME = "zagent" as const;
...
export const LEGACY_MACOS_APP_SOURCES_DIR = "apps/macos/Sources/ZAgent" as const;

export const MACOS_APP_SOURCES_DIR = "apps/macos/Sources/ZAgent" as const;
