...
function resolveAnthropicDefaultAuthMode(cfg: ZAgentConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ZAgentConfig): ZAgentConfig {
...
export function applyTalkApiKey(config: ZAgentConfig): ZAgentConfig {
...
export function applyModelDefaults(cfg: ZAgentConfig): ZAgentConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ZAgentConfig): ZAgentConfig {
...
export function applyLoggingDefaults(cfg: ZAgentConfig): ZAgentConfig {
...
export function applyContextPruningDefaults(cfg: ZAgentConfig): ZAgentConfig {
...
export function applyCompactionDefaults(cfg: ZAgentConfig): ZAgentConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
