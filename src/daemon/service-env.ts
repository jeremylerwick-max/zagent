...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    ZAGENT_PROFILE: profile,
    ZAGENT_STATE_DIR: env.ZAGENT_STATE_DIR,
    ZAGENT_CONFIG_PATH: env.ZAGENT_CONFIG_PATH,
    ZAGENT_GATEWAY_PORT: String(port),
    ZAGENT_GATEWAY_TOKEN: token,
    ZAGENT_LAUNCHD_LABEL: resolvedLaunchdLabel,
    ZAGENT_SYSTEMD_UNIT: systemdUnit,
    ZAGENT_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    ZAGENT_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    ZAGENT_STATE_DIR: env.ZAGENT_STATE_DIR,
    ZAGENT_CONFIG_PATH: env.ZAGENT_CONFIG_PATH,
    ZAGENT_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    ZAGENT_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    ZAGENT_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    ZAGENT_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    ZAGENT_LOG_PREFIX: "node",
    ZAGENT_SERVICE_MARKER: NODE_SERVICE_MARKER,
    ZAGENT_SERVICE_KIND: NODE_SERVICE_KIND,
    ZAGENT_SERVICE_VERSION: VERSION,
  };
}
