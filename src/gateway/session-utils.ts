...
import { type ZAgentConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: ZAgentConfig): string[] {
...
export function listAgentsForGateway(cfg: ZAgentConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ZAgentConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: ZAgentConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: ZAgentConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: ZAgentConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: ZAgentConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: ZAgentConfig): GatewaySessionsDefaults {
