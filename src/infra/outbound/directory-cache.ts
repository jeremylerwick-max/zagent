...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: ZAgentConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: ZAgentConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: ZAgentConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: ZAgentConfig): void {
    this.cache.clear();
    if (cfg) this.lastConfigRef = cfg;
  }

  private resetIfConfigChanged(cfg: ZAgentConfig): void {
