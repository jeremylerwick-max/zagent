...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "zagent-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveZAgentPackageRoot } = await import("./zagent-root.js");
    ...
    vi.mocked(resolveZAgentPackageRoot).mockResolvedValue("/opt/zagent");
