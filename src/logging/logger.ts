...
export const DEFAULT_LOG_DIR = "/tmp/zagent";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "zagent.log"); // legacy single-file path

const LOG_PREFIX = "zagent";
...
function resolveSettings(): ResolvedSettings {
  let cfg: ZAgentConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => ZAgentConfig;
      };
