...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @zagent/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageZAgent: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoverZAgentPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExt = path.join(workspaceRoot, ".zagent", "extensions");
    discoverInDirectory({
      dir: workspaceExt,
      origin: "workspace",
