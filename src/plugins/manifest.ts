...
export const PLUGIN_MANIFEST_FILENAME = "zagent.plugin.json";
...
// package.json "zagent" metadata (used for onboarding/catalog)
...
export type ZAgentPackageManifest = {
  extensions?: string[];
...
): ZAgentPackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.zagent ?? manifest[LEGACY_MANIFEST_KEY];
}
