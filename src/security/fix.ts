...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ZAgentConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ZAgentConfig; env: NodeJS.ProcessEnv }): {
  cfg: ZAgentConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
