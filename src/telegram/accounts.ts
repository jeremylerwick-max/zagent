...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.ZAGENT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: ZAgentConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: ZAgentConfig): string {
...
function mergeTelegramAccountConfig(cfg: ZAgentConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: ZAgentConfig): ResolvedTelegramAccount[] {
