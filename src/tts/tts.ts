...
export function resolveTtsConfig(cfg: ZAgentConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.ZAGENT_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: ZAgentConfig): string | undefined {
